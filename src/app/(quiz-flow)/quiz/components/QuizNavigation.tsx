...
export function QuizNavigation({ onNext, isNextDisabled = false }: QuizNavigationProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[55] bg-background border-b border-border p-4 md:p-6 flex flex-col justify-center sm:flex-row sm:justify-end items-center gap-4">
